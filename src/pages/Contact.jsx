...
const Contact = () => {
  return (
    <>
      <section className="w-full max-w-7xl px-6 lg:px-8 m-auto">
        <div className="lg:mb-16 mt-10 mb-10 ">
          ...
          <h2 className="lg:text-4xl text-3xl font-manrope text-center font-bold text-gray-900 leading-tight">
            Your Destination for Expert Care
          </h2>
        </div>
        <div className="w-full h-0 pb-[56.25%] relative overflow-hidden rounded-lg shadow-lg">
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3784.525886865102!2d73.8774803!3d18.459823599999996!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bc2c11ba2967271%3A0xe7d712cc2ee17fc4!2sDr.Monica%20Jain%20(MBBS%2C%20MD)%20%7C%20LASER%20CLINIC%20%7C%20Hydra%20facial%20%7C%20Skin%20Specialist%20%7C%20Kondhwa!5e0!3m2!1sen!2sin!4v1736671459706!5m2!1sen!2sin"
          ...
          <div className="grid lg:grid-cols-2 grid-cols-1 gap-x-16 xl:gap-x-24 gap-y-14 max-w-lg md:max-w-3xl lg:max-w-full mx-auto">
            <div>
              ...
              <div className="my-12 grid md:grid-cols-2 grid-cols-1 md:gap-x-8 gap-y-8">
                <div className="rounded-2xl border border-gray-200 bg-white p-7 group transition-all duration-500 hover:bg-black">
                  <a
                    href="javascript:;"
                    className="w-14 h-14 bg-black rounded-full flex items-center justify-center mb-5 transition-all duration-500 group-hover:bg-white cursor-pointer"
                  >
                    <svg
                      className="fill-white transition-all duration-500 group-hover:fill-blue-600"
                      width={30}
                      height={30}
                      viewBox="0 0 30 30"
                      fill="none"
                  ...
                  <p className="text-gray-500 text-sm font-normal leading-5 transition-all duration-500 group-hover:text-white">
                    We provide a range of personalized methods to address all
                    your skin and hair care needs, tailored to suit your unique
                ...
                <div className="rounded-2xl border border-gray-200 bg-white p-7 group transition-all duration-500 hover:bg-black">
                  ...
                  >
                    <svg
                      className="stroke-white transition-all duration-500 group-hover:stroke-blue-600"
                      width={30}
                      height={30}
                      viewBox="0 0 30 30"
                      fill="none"
                  ...
                  <p className="text-gray-500 text-sm font-normal leading-5 transition-all duration-500 group-hover:text-white">
                    We employ the latest techniques and technologies to ensure
                    the safety and well-being of your skin and hair at every
            ...
            <form className="h-fit bg-white border border-slate-200 rounded-2xl lg:p-12 p-8 w-full max-w-lg md:max-w-3xl lg:max-w-full mx-auto">
              ...
              <button className="w-full h-12 rounded-full bg-black hover:bg-blue-900 transition-all duration-700 shadow-sm text-white text-base font-semibold leading-6 flex items-center justify-center">
                Send message{" "}
                <svg
                  width={20}
                  height={20}
